...
<div align="center">
  ...
  <!-- Nova animação de programação -->
  <img align="left" height="250" alt="coding-time" src="https://raw.githubusercontent.com/gabvieiras/gabvieiras/main/code.gif">
  
  <!-- Se a animação acima não funcionar, use uma destas alternativas: -->
  <!--
  <img align="left" height="250" alt="coding-animation" src="https://cdn.dribbble.com/users/1162077/screenshots/3848914/programmer.gif">
  
  <img align="left" height="250" alt="coding-animation" src="https://i.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.webp">
  -->
...
<!-- Se você quer uma nova animação personalizada, siga estas opções: -->

## 🔧 Como adicionar uma nova animação:

### Opção 1: Usar um GIF online (mais fácil)
1. Escolha um GIF de programação de sites como:
   - [Giphy](https://giphy.com/search/programming)
   - [Dribbble](https://dribbble.com/tags/coding_animation)
   - [Tenor](https://tenor.com/search/programming-gifs)

2. Substitua o link no código por:
```markdown
<img align="left" height="250" alt="coding-animation" src="URL_DO_SEU_GIF_AQUI">
